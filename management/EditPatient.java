...
public class EditPatient extends JFrame {
	...
	public EditPatient() {
		...
		JButton btnNewButton_3 = new JButton("Patient's id");
		...
		JButton btnNewButton_4 = new JButton("Patient's name");
		...
		JButton btnNewButton_5 = new JButton("Disease");
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			private void btnNewButton_2ActionPerformed(ActionEvent ev) {
                ...
                String sql = "UPDATE `patient` SET `Patient's name`='"+textField_1.getText()+"',`Disease`='"+textField_2.getText()+"' WHERE `Patient's id`='"+textField.getText()+"'";
