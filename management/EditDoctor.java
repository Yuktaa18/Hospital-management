...
public class EditDoctor extends JFrame {
	...
	public EditDoctor() {
		...
		btnNewButton_4.setBounds(565, 281, 185, 40);
		contentPane.add(btnNewButton_4);
		
		JButton btnNewButton_5 = new JButton("Specialization");
		...
		btnNewButton_1.setBounds(944, 528, 129, 40);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			private void btnNewButton_2ActionPerformed(ActionEvent ev) {
                ...
                String sql = "UPDATE `doctor` SET `Doctor's name`='"+textField_1.getText()+"',`Doctor's spec`='"+textField_2.getText()+"' WHERE `Doctor's id`='"+textField.getText()+"'";
