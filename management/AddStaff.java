...
public class AddStaff extends JFrame {
	...
	public AddStaff() {
		...
		di = new JTextField();
		di.setBounds(886, 164, 205, 42);
		contentPane.add(di);
		di.setColumns(10);
		
		dn = new JTextField();
		dn.setBounds(886, 251, 205, 42);
		contentPane.add(dn);
		dn.setColumns(10);
		
		ds = new JTextField();
		ds.setBounds(886, 339, 205, 42);
		contentPane.add(ds);
		ds.setColumns(10);
		...
		JButton btnNewButton_5 = new JButton("Staff's work");
		...
		btnNewButton_2.setBounds(796, 424, 108, 49);
