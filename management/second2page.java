...
public class second2page extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					second2page frame = new second2page();
	...
	public second2page() {
		...
		JButton btnNewButton_1 = new JButton("Edit Patient's Datail");
		...
		JButton btnNewButton_3 = new JButton("Display Patient's Details");
